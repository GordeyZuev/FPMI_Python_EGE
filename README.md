...
|:-|:-|:-:|:-:|
|**01. [`Python` - I. Введение.](/01.%20Introduction.ipynb)** | Знакомство. Ввод и вывод. Переменные и числа, операторы сравнения. | - | 24.03.25 | 24.03.25|
...
|**13. [Большое повторение]()** | Консультация - ответы на любые вопросы. И повторение важных тем  | - | 06.06.25 |
